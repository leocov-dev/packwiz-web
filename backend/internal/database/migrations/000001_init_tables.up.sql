...
CREATE UNIQUE INDEX idx_mods_pack_mod_slug ON mods(pack_id, slug);
...
CREATE UNIQUE INDEX idx_pack_users_pack_id_user_id ON pack_users(pack_id, user_id);
CREATE UNIQUE INDEX idx_pack_users_user_id_pack_id ON pack_users(user_id, pack_id);
